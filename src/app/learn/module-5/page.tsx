...
import { MODULE_5, MODULE_5_ID } from "@/features/curriculum/modules";
...
export default async function Module5Page() {
  ...
  if (!user) {
    redirect("/login?redirectTo=/learn/module-5");
  }
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-14 sm:px-6 md:py-20">
      ...
      <p className="mt-1 text-muted-foreground">{MODULE_5.subtitle}</p>
      ...
      <div className="mt-10">
        <LessonList
          ...
          completionCopy={{
            heading: "You've completed Module 5.",
            body: "Broken chords, alternating bass, and the oom-pah pattern — you're not just playing chords anymore, you're accompanying.",
          }}
        />
      </div>
    </div>
