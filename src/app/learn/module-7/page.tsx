...
import { MODULE_7, MODULE_7_ID } from "@/features/curriculum/modules";
...
export default async function Module7Page() {
  ...
  if (!user) {
    redirect("/login?redirectTo=/learn/module-7");
  }
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-14 sm:px-6 md:py-20">
      ...
      <p className="mt-1 text-muted-foreground">{MODULE_7.subtitle}</p>
      ...
      <div className="mt-10">
        <LessonList
          ...
          completionCopy={{
            heading: "You've completed Module 7.",
            body: "Your chords, your verse, your chorus, your melody — you wrote a song, start to finish.",
          }}
        />
      </div>
    </div>
