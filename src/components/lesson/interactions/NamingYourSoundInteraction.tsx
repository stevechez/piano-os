...
const SONG_CHORDS = getProgression("mySong").chordIds.map(getChord);
...
export function NamingYourSoundInteraction({ onComplete }: LessonInteractionProps) {
  return (
    <ChoiceInteraction
      prompt="Your song, played two ways. The chords never change — only how you choose to play them."
      options={OPTIONS}
