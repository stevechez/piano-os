...
const VERSE_CHORDS = getProgression("myThirdVerse").chordIds.map(getChord);
const CHORUS_CHORDS = getProgression("myThirdChorus").chordIds.map(getChord);
...
export function ThirdVerseIntoChorusInteraction({ onComplete }: LessonInteractionProps) {
  return (
    <ChoiceInteraction
