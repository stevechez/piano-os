...
const VERSE_CHORDS = getProgression("myMinorVerse").chordIds.map(getChord);
const CHORUS_CHORDS = getProgression("myMinorChorus").chordIds.map(getChord);
...
export function VerseIntoMinorChorusInteraction({ onComplete }: LessonInteractionProps) {
  return (
    <ChoiceInteraction
      prompt="Compare looping your verse to letting it move into your chorus."
      options={OPTIONS}
